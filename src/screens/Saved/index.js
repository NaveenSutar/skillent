...
export default class Saved extends Component {
    ...
    _getJobs = async () => {
        ...
        try {
            ...
            axios.get(api.candidate_jobs + "?scope=saved", config)
                .then((response) => {
        ...
        return (
            <>
                ...
                <SafeAreaView style={styles.container} edges={['top', 'left', 'right']}>
                    ...
                    <Header text="Saved Jobs" colour={colours.skilent_textPrimary} />
                    ...
                    <View style={styles.workingContainer}>

                        {
                            jobsData.length == 0
                                ...
                                ?
                                this.state.loading ? <></> : <Information infoText="You have no saved jobs" />
                                :
                                <FlatList
