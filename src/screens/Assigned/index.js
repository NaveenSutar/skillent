...
export default class Assigned extends Component {
    ...
    _getJobs = async () => {
        ...
        try {
            ...
            axios.get(api.candidate_jobs + "?scope=assigned", config)
                .then((response) => {
        ...
        return (
            <>
                ...
                <SafeAreaView style={styles.container} edges={['top', 'left', 'right']}>
                    ...
                    <Header arrow={true} text="Assigned Jobs" colour={colours.skilent_textPrimary} />
                    ...
                    <View style={styles.workingContainer}>

                        {
                            jobsData.length == 0
                                ...
                                ?
                                this.state.loading ? <></> : <Information infoText="You have no assigned jobs" />
                                :
                                <FlatList
